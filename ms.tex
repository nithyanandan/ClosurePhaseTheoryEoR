...
Another primary application of this approach is to estimate $T_{21}(z)$ using the separation in delay power spectrum, $P_\textrm{abc}(k_\parallel)$, demonstrated above. 
