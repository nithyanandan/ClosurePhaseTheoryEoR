...
\begin{abstract} 
  ...
  instruments. \added[id=NT]{Our approach will also benefit other 
  \HI\ intensity mapping experiments that face similar challenges, 
  such as those measuring Baryon Acoustic Oscillations (BAO).}
\end{abstract}
