...
\begin{abstract}
Detecting neutral Hydrogen (H~{\sc i}) via 21~cm line emission in the intergalactic medium at $z\gtrsim 6$ has been identified as one of the most direct and promising probes of {\it cosmic dawn} and the epoch of reionization (EoR) -- epochs that signify major transitions in the Universe. Current experiments have found it challenging to detect H~{\sc i} from these cosmic epochs because bright astrophysical foreground objects such as radio galaxies and the Milky Way, and ionospheric and instrumental effects overwhelm the cosmic signal by many orders of magnitude. It requires extremely precise antenna calibration, a feat that has been very hard to achieve. We propose using measurements of interferometric bi-spectrum phase to eliminate this requirement. This quantity carries information purely about the sky besides stochastic measurement noise and is unaffected by antenna calibrations and uncertainties therein. We show that the bi-spectrum phase of foreground continuum emission has a characteristically smooth spectrum relative to the cosmological signal. They can be separated effectively by exploiting this spectral difference using a Fourier technique like the ``delay spectrum'', while eliminating the need for precise direction-independent antenna-based calibration altogether that would have been otherwise essential to account for phases introduced by instrumental and ionospheric effects in existing approaches. By removing this burden, our approach could potentially improve the prospects of directly detecting these high-redshift cosmic epochs. Based on fiducial models for foregrounds and EoR, the latter should be detectable with high significance at $|k_\parallel| \gtrsim 0.5\,h$~Mpc$^{-1}$.
\end{abstract}
...
A paramount goal in modern astrophysics and cosmology is the characterization of major transitions the Universe has undergone since the recombination era ($\sim 300,000$ years after the Big Bang, $z\approx 1100$). Since then the Universe remained predominantly neutral (known as the ``Dark Ages'') until the gravitational collapse around peaks in the primordial matter density fluctuations created the first astrophysical objects, namely, stars and galaxies ($\sim$ 200--400 million years after the Big Bang) that produced photons energetic enough to re-ionize the intergalactic medium around them. This epoch is known as ``cosmic dawn''. It evolved into the epoch of reionization (EoR), an epoch in the Universe where photon-to-baryon ratio eventually exceeded unity making the entire Universe ionized again (except gas bound to galaxies), marking the end of EoR ($\sim$ 1 billion years after Big Bang, or $z\gtrsim 6$). The astrophysical processes in these epochs shaped the evolution of gas and galaxy, and large-scale structure in the Universe. However, they are among the most poorly explored epochs in the Universe's history. The redshifted 21~cm spectral line from the spin-flip transition of electron spin in an atom of neutral Hydrogen (H~{\sc i}), the most abundant atomic species in these epochs, promises to be most direct probe yet in filling gaps in our understanding of the Universe's history \cite{sun72,sco90,mad97,toz00,ili02,fan02,fan06,bar07,mor10}.
...
As discussed above, we require $\sigma_{\phi_\Delta^\textrm{H{\sc i}}} > \sigma_{\phi_\Delta^\textrm{N}}$ such that $\phi_\Delta^\textrm{F}, \delta\phi_\Delta^\textrm{H{\sc i}} > \delta\phi_\Delta^\textrm{N}$ in order to detect EoR and estimate $\rho_{ab}^\textrm{H{\sc i}}$. This can be achieved by a combination of the following.
...
We show that it has parallels with existing approaches and demonstrate that differences in spectral characteristics of the EoR H~{\sc i} and bright foregrounds in bi-spectrum phase can be used to separate them using an approach like delay-spectrum. We note the prospects of detection and EoR model constraints can be further improved in a number of ways relative to the simple analysis presented here. We have listed a number of challenges that may limit this approach while noting that even existing approaches are subject to most of these challenges.
