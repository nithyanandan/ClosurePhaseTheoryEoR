...
% Fig.~\ref{fig:cpphase-cartoon} illustrates the distribution of $\phi_\Delta^\textrm{m}$ in the complex plane for high and low values of $\rho_{ab}^\textrm{N},\rho_{bc}^\textrm{N},\rho_{ca}^\textrm{N}$. 
